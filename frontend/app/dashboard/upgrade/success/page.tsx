      ...
      <div className="max-w-2xl w-full">
        <div className="card text-center">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8 text-left">
            <div className="bg-blue-50 p-4 rounded-lg">
              <div className="flex items-center mb-2">
                ...
                <span className="font-semibold text-gray-900 dark:text-white">Token Limit</span>
              </div>
              <p className="text-2xl font-bold text-primary">{info.tokens}/month</p>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-3">All {info.name} Features:</h3>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-600 dark:text-dark-text-muted">
            ...
            <a href="mailto:support@promptrouter.com" className="text-primary hover:underline font-medium">
              Contact Support
            </a>
          </p>
        </div>
